...
const sell3_boughtUnitPrice = 0.02;
const sell3_Qty = 15427798.31;
const sell3_valueUSDatTimeOfTransaction = sell3_boughtUnitPrice * sell3_Qty;
...
const sell3DV = {
  ...
  boughtValue: sell3_valueUSDatTimeOfTransaction,
};
...
describe("[mocha conversion]", async () => {
  ...
  it("sell3DV should convert nicely", () => {
    ...
    assert.strictEqual(sell3FE.boughtValue, sell3_valueUSDatTimeOfTransaction);
    assert.strictEqual(sell3FE.soldDate, sell3_transactionDate);
